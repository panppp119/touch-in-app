...
const Card = styles(Link)`
  background: linear-gradient(97.41deg, #FF9897 1.01%, #F650A0 100%);
  border-radius: 12px;
  padding: 10px;
  display: flex;
  align-items: center;
...
class CheckInCardWFH extends React.Component {
  render() {
